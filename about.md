...
* To get started with Dedicated {{site.data.keyword.keymanagementserviceshort}}, see [Creating a Dedicated {{site.data.keyword.keymanagementserviceshort}} instance](/docs/key-protect?topic=key-protect-st-init-cli&interface=cli).
