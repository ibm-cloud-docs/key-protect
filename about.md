...
* **Low cost**: Your first five key versions are free, with each subsequent key version costing USD1.045. To learn more about keys, key versions, and pricing, check out [Pricing](/docs/key-protect?topic=key-protect-pricing-plan).
