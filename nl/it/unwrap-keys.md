...
[Dopo aver effettuato una chiamata di impacchettamento al servizio](/docs/services/key-protect/wrap-keys.html), puoi spacchettare una chiave di crittografia dei dati (DEK) specificata per accedere al suo contenuto eseguendo una chiamata `POST` al seguente endpoint.
