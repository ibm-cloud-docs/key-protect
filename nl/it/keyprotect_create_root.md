...
[Dopo aver creato un'istanza del servizio](/docs/services/keymgmt/keyprotect_provision.html), completa la seguente procedura per creare una chiave root con la GUI {{site.data.keyword.keymanagementserviceshort}}.
