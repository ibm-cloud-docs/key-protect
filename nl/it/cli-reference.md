...
Puoi utilizzare il plug-in della CLI {{site.data.keyword.keymanagementserviceshort}} per gestire le chiavi nella tua istanza di {{site.data.keyword.keymanagementserviceshort}}.
{:shortdesc}

Per installare il plug-in della CLI, vedi [Configurazione della CLI](/docs/services/key-protect/set-up-cli.html). 

Quando esegui l'accesso alla CLI [{{site.data.keyword.cloud_notm}} ![Icona link esterno](../../icons/launch-glyph.svg "Icona link esterno")](/docs/cli/index.html#overview){: new_window}, vieni informato quando sono disponibili degli aggiornamenti. Assicurati di tenere aggiornata la tua CLI in modo da poter usare i comandi e gli indicatori disponibili per il plug-in della CLI {{site.data.keyword.keymanagementserviceshort}}.
{: tip}
...
[Crea una chiave root](/docs/services/key-protect/create-root-keys.html) nell'istanza del servizio {{site.data.keyword.keymanagementserviceshort}} che specifichi. 
...
<dl>
    ...
    <dt><code>-s, --standard-key</code></dt>
        <dd>Imposta il parametro solo se vuoi creare una <a href="/docs/services/key-protect/concepts/envelope-encryption.html#key-types">chiave standard</a>. Per creare una chiave root, ometti il parametro <code>--standard-key</code>.</dd>
</dl>

## kp delete
{: #kp-delete}

[Elimina una chiave](/docs/services/key-protect/delete-keys.html) archiviata nel tuo servizio {{site.data.keyword.keymanagementserviceshort}}.
...
[Esegui la rotazione di una chiave root](/docs/services/key-protect/wrap-keys.html) archiviata nel tuo servizio {{site.data.keyword.keymanagementserviceshort}}.
...
[Impacchetta una chiave di crittografia dei dati (o DEK, data encryption key)](/docs/services/key-protect/wrap-keys.html) utilizzando una chiave root archiviata nell'istanza del servizio {{site.data.keyword.keymanagementserviceshort}} da te specificata.
...
[Spacchetta una DEK (data encryption key)](/docs/services/key-protect/unwrap-keys.html) utilizzando una chiave root archiviata nella tua istanza del servizio {{site.data.keyword.keymanagementserviceshort}}.
