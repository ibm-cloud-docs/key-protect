...
4. Pour créer une clé, cliquez sur **Ajouter une clé**, puis sélectionnez la fenêtre **Créer une clé**.
    ...
    <table>
      ...
      <tr></tr>
        <td>Key type</td>
        <td><a href="/docs/services/key-protect/concepts?topic=key-protect-envelope-encryption#key-types">Type de clé</a> que vous souhaitez gérer dans {{site.data.keyword.keymanagementserviceshort}}. Dans la liste des types de clé, sélectionnez <b>Standard Key</b>.</td>
      </tr>
