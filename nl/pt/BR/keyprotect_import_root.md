...
[Depois de criar uma instância do serviço](/docs/services/keymgmt/keyprotect_provision.html), conclua as etapas a seguir para incluir sua chave raiz existente com a {{site.data.keyword.keymanagementserviceshort}}do GUI.
...
3. Opcional: verifique se a chave foi incluída executando a chamada a seguir para procurar as chaves em sua instância de serviço do {{site.data.keyword.keymanagementserviceshort}}.
...
**Nota:** ao incluir uma chave raiz existente no serviço, a chave permanece dentro dos limites de {{site.data.keyword.keymanagementserviceshort}} e seu material da chave não pode ser recuperado. 
