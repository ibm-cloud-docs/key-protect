...
[Após você fazer uma chamada de agrupamento para o serviço](/docs/services/keymgmt/keyprotect_wrap_keys.html), poderá desagrupar uma chave de criptografia de dados (DEK) especificada para acessar os seus conteúdos fazendo uma chamada `POST` para o terminal a seguir.
...
4. Execute o comando cURL a seguir para decriptografar e autenticar o material da chave.
    ...
    ```cURL curl -X POST \ 'https://keyprotect.<region>.bluemix.net/api/v2/keys/<key_ID>?action=unwrap' \
