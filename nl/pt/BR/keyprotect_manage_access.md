...
- Para aprender sobre como conceder permissões avançadas para acessar chaves de criptografia específicas, veja [Gerenciando o acesso a chaves](/docs/services/keymgmt/keyprotect_manage_access_api.html).
