...
要使用 API，请生成认证凭证，例如，[访问令牌](/docs/services/keymgmt/keyprotect_authentication.html#retrieve_token)和[实例标识](/docs/services/keymgmt/keyprotect_authentication.html#retrieve_instance_ID)。您还需要想要管理其访问权的 {{site.data.keyword.keymanagementserviceshort}} 密钥的标识。 

要了解如何查看密钥标识，请参阅[查看密钥](/docs/services/keymgmt/keyprotect_view_keys.html)。
{: tip} 
...
1. [要求用户提供 IAM 令牌](/docs/services/keymgmt/keyprotect_authentication.html#retrieve_token)。
    IAM 令牌结构如下：
