...
"collectionType": "application/vnd.ibm.kms.key+json",
    ...
    <table>
      ...
      <tr>
        ...
        <td>您的 {{site.data.keyword.cloud_notm}} 访问令牌。在 cURL 请求中包含 <code>IAM</code> 令牌的完整内容，包括 Bearer 值。有关更多信息，请参阅<a href="/docs/services/key-protect/access-api#retrieve-token">检索访问令牌</a>。</td>
      </tr>
      <tr>
