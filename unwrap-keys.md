...
{: caption="Describes the variables that are needed to unwrap keys in {{site.data.keyword.keymanagementserviceshort}}." caption-side="bottom"}
...
{: caption="Describes the variables that are needed to decode your key material." caption-side="bottom"}
