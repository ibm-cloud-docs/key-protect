...
When you try to delete your {{site.data.keyword.keymanagementserviceshort}} service instance, the service fails to delete as expected.

From the {{site.data.keyword.cloud_notm}} dashboard, you navigate to **Cloud Foundry Services**, and you select your instance of {{site.data.keyword.keymanagementserviceshort}}. You click the ⋮ icon to open a list of options for the service offering, and you click **Delete Service**.
{: tsSymptoms}
