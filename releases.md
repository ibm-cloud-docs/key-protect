...
You can create and manage {{site.data.keyword.keymanagementserviceshort}} resources on IBM Cloud's private network by targeting a private service endpoint in the staging environment.
To view the endpoint, see [Stage Endpoints](/docs/key-protect?topic=key-protect-usage#usage-stage-endpoints). To find out more about using private endpoints, see [Using Private Endpoints](/docs/key-protect?topic=key-protect-private-endpoints).
...
changed event fields do not affect your audit operations.
