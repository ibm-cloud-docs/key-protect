...
{: caption="Ties key states to the time from a key's deletion to what actions are possible with the key." caption-side="bottom"}
...
{: caption="Describes the variables that are needed to restore keys with the {{site.data.keyword.keymanagementserviceshort}} API" caption-side="bottom"}
