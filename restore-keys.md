...
All keys, whether created in {{site.data.keyword.keymanagementserviceshort}} or imported, and whether it is a root or standard key, can be restored.
{: important}
