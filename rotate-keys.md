...
{: caption="Describes the variables that are needed to rotate a specified key in {{site.data.keyword.keymanagementserviceshort}}." caption-side="bottom"}
...
{: caption="Describes the variables that are needed to rotate a key that has an import token." caption-side="bottom"}
