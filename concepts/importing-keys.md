...
for your service instance, {{site.data.keyword.keymanagementserviceshort}}
...
[see the {{site.data.keyword.keymanagementserviceshort}} API reference doc](https://{DomainName}/apidocs/key-protect#create-an-import-token){: external}.
{: note}
