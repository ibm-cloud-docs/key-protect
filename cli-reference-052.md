...
# CLI - 0.5.2 (deprecated)
{: #cli-reference-five-two}
...
## Notes
{: #cli-reference-five-two-notes}

### Previous version
{: #cli-reference-five-two-previous}
...
### Examples
{: #cli-reference-five-two-examples}
...
| [nonce-encrypt](#kp-import-token-nonce-encrypt) | Update        | Encrypt the nonce that is generated by `kp import-token create` |
...
[setting the key for deletion](/docs/key-protect?topic=key-protect-delete-dual-auth-keys&interface=api#delete-dual-auth-keys-set-key-deletion-api).
...
[
  {
    ...
    "keyVersion": {
      ...
      "creationDate": "2020-06-15T16:05:53Z"
    }
  }
]
```
