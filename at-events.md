...
[Launching the web UI through the IBM Cloud UI](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-launch#launch_step2){: external}.
...
your service instance and `responseData.totalResources` is 0, you may need to
