...
[restart the dual authorization process](/docs/key-protect?topic=key-protect-delete-dual-auth-keys&interface=api#delete-dual-auth-keys-delete-dual-auth-keys-set-key-deletion-api)
    to delete the key.
{: note}
