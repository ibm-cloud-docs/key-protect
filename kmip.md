...
{: caption="Describes the variables that are needed to create a KMIP adapter in {{site.data.keyword.keymanagementserviceshort}}." caption-side="top"}
...
{: caption="Describes the variables that are needed to create a KMIP client certificate in {{site.data.keyword.keymanagementserviceshort}}." caption-side="top"}
