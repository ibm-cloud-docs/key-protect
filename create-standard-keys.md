...
If you enable [dual authorization settings for your service instance](/docs/key-protect?topic=key-protect-manage-dual-auth),
...
4. To create a new key, click **Add key** and select the **Create a key** window.
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          The <a href="/docs/key-protect/concepts?topic=key-protect-envelope-encryption#key-types">type of key</a>
          that you would like to manage in {{site.data.keyword.keymanagementserviceshort}}.
          From the list of key types, select <b>Standard key</b>.
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          ...
          <p>
            ...
            entity-body. When you set the variable to <code>return=representation</code>,
