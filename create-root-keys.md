...
4. To create a new key, click **Add key**. A side panel will open. Make sure the **Create a key** option is selected. Note that to set a **Key alias**, **Key Ring**, or **Rotation policy** for this key, you must click the **Advanced options** tab to reveal them.
